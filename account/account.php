    ...
    <div class="home-content">
        <div class="table-container">
            <div class="table-heading">
                <h3 class="table-title">User Profile</h3>
                <?php
                    if($_SESSION['user_type'] == 'admin'){
                ?>
                    <a href="addaccount.php" class="button">Add New User</a>
                <?php
                    }
                ?>
            </div>
                    ...
                    ?>
                        <tr>
                            ...
                            ?>
                                <td>
                                    <div class="action">
                                        <a class="action-edit" href="editaccount.php?id=<?php echo $value['id'] ?>">Edit</a>
                                        <a class="action-delete" href="deleteaccount.php?id=<?php echo $value['id']?>">Delete</a>
                                    </div>
                                </td>
                            <?php
                                }
