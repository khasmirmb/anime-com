<?php
    ...
    */
    ...
    if(isset($_POST['save'])){
        ...
        $choices->id = htmlentities($_POST['choices-id']);
        ...
        if ($choices->fetch($_GET['id'])){
            $data = $choices->fetch($_GET['id']);
            $choices->id = $data['id'];
            $choices->anime_name = $data['anime_name'];
            $choices->description = $data['description'];
            $choices->image = $data['image'];
            $choices->poll = $data['poll'];
        }
    }
    ...
    <div class="home-content">
        <div class="table-container">
            ...
            <div class="add-form-container">
                ...
                <input type="text" hidden name="choices-id" value="<?php echo $choices->id ; ?>">

                    <label for="anime_name">Name</label>
                    <input type="text" id="anime_name" name="anime_name" required placeholder="Enter Name" value="<?php if(isset($_POST['anime_name'])) { echo $_POST['anime_name'];} else { echo $choices->anime_name; } ?>">

                    <label for="description">Description</label>
                    <input type="text" id="description" name="description" required placeholder="Enter Description" value="<?php if(isset($_POST['description'])) { echo $_POST['description'];} else { echo $choices->description; } ?>">

                    <label for="image">Image</label>
                    <input type="text" id="image" name="image" required placeholder="Enter Image" value="<?php if(isset($_POST['image'])) { echo $_POST['image'];} else { echo $choices->image; } ?>">
