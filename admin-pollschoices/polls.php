    ...
    <div class="home-content">
        <div class="table-container">
            <div class="table-heading">
                <h3 class="table-title">Poll Choices List</h3>
                <?php
                    if($_SESSION['user_type'] == 'admin'){
                ?>
                    <a href="addpolls.php" class="button">Add New Choices</a>
                <?php
                    }
                ?>
            </div>
            <table class="table">
                ...
                <tbody>
                    <?php
                        ...
                        foreach ($choices->show() as $value){ //start of loop
                    ?>
                        <tr>
                            <!-- always use echo to output PHP values -->
                            <td><?php echo $i ?></td>
                            <td><b><?php echo $value['poll_name']?></b></td>
                            <td><?php echo $value['anime_name']?></td>
                            ...
                            ?>
                                <td>
                                    <div class="action">
                                        <a class="action-edit" href="editpolls.php?id=<?php echo $value['id'] ?>">Edit</a>
                                        <a class="action-delete" href="deletepolls.php?id=<?php echo $value['id']?>">Delete</a>
                                    </div>
                                </td>
                            <?php
                                }
